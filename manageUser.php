...
<nav class="navbar navbar-expand-lg sticky-sm-top" style=" background-color: #6B4A3F">
  ...
  <div class="col-8 col-md-10 text-end">
      ...
      <div class="collapse navbar-collapse ml-auto" id="navbarNav">
        <ul class="navbar-nav justify-content-end">
          ...
          <li class="nav-item">
            <a class="nav-link  active" aria-current="page" href="manageUser.php">Manage users </a>
          </li>
          <li class="nav-item">
  ...
  <div class="container-fluid py-4 " style="height: 100vh;" id="userTable">
  <div class="table-responsive">
            <table class="table table-striped caption-top" >
                <caption style="font-size:24px; font-weight:bold">List of users</caption>
                <thead>
                    <tr>
                        <th>USER ID</th>
                        <th>USER NAME</th>
                ...
                <tbody class="table-group-divider">
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td><button type='button' class='btn btn-no-radius'  onclick=\"window.location.href='projectDel.php?id=" . $row["id"] . "'\" >Delete</button></td></tr></tbody>";
                        }
                    } else {
